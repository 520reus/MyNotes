...
\begin{DoxyCompactList}\small\item\em Optimize a previously initialized trajectory (actual TEB optimization loop). \end{DoxyCompactList}\end{DoxyCompactItemize}
\end{Indent}
...
const \mbox{\hyperlink{classteb__local__planner_1_1TebConfig}{Teb\+Config}} $\ast$ \mbox{\hyperlink{classteb__local__planner_1_1TebOptimalPlanner_a8455e6300b1b02d0a16ce3174ce9f673}{cfg\+\_\+}}
...
Obst\+Container $\ast$ \mbox{\hyperlink{classteb__local__planner_1_1TebOptimalPlanner_aa9e885d06c3effab5c129687c3d77953}{obstacles\+\_\+}}
...
const Via\+Point\+Container $\ast$ \mbox{\hyperlink{classteb__local__planner_1_1TebOptimalPlanner_aaceedc4c110d45e895509e14b083540b}{via\+\_\+points\+\_\+}}
\begin{DoxyCompactList}\small\item\em Store via points for planning \end{DoxyCompactList}\item 
...
std\+::vector$<$ Obst\+Container $>$ \mbox{\hyperlink{classteb__local__planner_1_1TebOptimalPlanner_a87e9a024cb3720022683cf47bcb1a206}{obstacles\+\_\+per\+\_\+vertex\+\_\+}}
\begin{DoxyCompactList}\small\item\em Store the obstacles associated with the n-\/1 initial vertices \end{DoxyCompactList}\item 
...
double \mbox{\hyperlink{classteb__local__planner_1_1TebOptimalPlanner_a841d6785ed5c68d1ef00218697987e58}{cost\+\_\+}}
\begin{DoxyCompactList}\small\item\em Store cost value of the current hyper-\/graph \end{DoxyCompactList}\item 
...
Rot\+Type \mbox{\hyperlink{classteb__local__planner_1_1TebOptimalPlanner_ae0d48be92ddd0d3e9c8ac7ef49a6d036}{prefer\+\_\+rotdir\+\_\+}}
\begin{DoxyCompactList}\small\item\em Store whether to prefer a specific initial rotation in optimization (might be activated in case the robot oscillates) \end{DoxyCompactList}\item 
...
Teb\+Visualization\+Ptr \mbox{\hyperlink{classteb__local__planner_1_1TebOptimalPlanner_ae6c0e9ab32c5c4b51c5e603fc607407d}{visualization\+\_\+}}
\begin{DoxyCompactList}\small\item\em Instance of the visualization class \end{DoxyCompactList}\item 
...
\mbox{\hyperlink{classteb__local__planner_1_1TimedElasticBand}{Timed\+Elastic\+Band}} \mbox{\hyperlink{classteb__local__planner_1_1TebOptimalPlanner_a801394856b20e94b3f81dc8d60cf9e14}{teb\+\_\+}}
\begin{DoxyCompactList}\small\item\em Actual trajectory object \end{DoxyCompactList}\item 
...
Robot\+Footprint\+Model\+Ptr \mbox{\hyperlink{classteb__local__planner_1_1TebOptimalPlanner_ac4080b9d944dd849f818be2ffb197c6d}{robot\+\_\+model\+\_\+}}
\begin{DoxyCompactList}\small\item\em Robot model \end{DoxyCompactList}\item 
...
boost\+::shared\+\_\+ptr$<$ g2o\+::\+Sparse\+Optimizer $>$ \mbox{\hyperlink{classteb__local__planner_1_1TebOptimalPlanner_a50b43b65c9427ddb7d210830ed34fe49}{optimizer\+\_\+}}
\begin{DoxyCompactList}\small\item\em g2o optimizer for trajectory optimization \end{DoxyCompactList}\item 
...
std\+::pair$<$ bool, geometry\+\_\+msgs\+::\+Twist $>$ \mbox{\hyperlink{classteb__local__planner_1_1TebOptimalPlanner_aff60efe55052e8dafc7f6a71245c3669}{vel\+\_\+start\+\_\+}}
\begin{DoxyCompactList}\small\item\em Store the initial velocity at the start pose \end{DoxyCompactList}\item 
...
std\+::pair$<$ bool, geometry\+\_\+msgs\+::\+Twist $>$ \mbox{\hyperlink{classteb__local__planner_1_1TebOptimalPlanner_a776fa3b9572a9772b7cacf21ab6ac1bc}{vel\+\_\+goal\+\_\+}}
\begin{DoxyCompactList}\small\item\em Store the final velocity at the goal pose \end{DoxyCompactList}\item 
...
bool \mbox{\hyperlink{classteb__local__planner_1_1TebOptimalPlanner_a64906f916610fb60eb7a6128f97f0094}{initialized\+\_\+}}
...
bool \mbox{\hyperlink{classteb__local__planner_1_1TebOptimalPlanner_a5bf0e611c4f633d96e3f848a5a90f236}{optimized\+\_\+}}
\begin{DoxyCompactList}\small\item\em This variable is {\ttfamily true} as long as the last optimization has been completed successful \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Optimize the previously constructed hyper-\/graph to deform / optimize the TEB. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Compute the velocity profile of the trajectory \end{DoxyCompactList}\item 
...
\item[\mbox{\hyperlink{todo__todo000005}{待办事项}}]\+: Call \mbox{\hyperlink{classteb__local__planner_1_1TebOptimalPlanner_a2b9ad598cec60b56906806603fa45497}{build\+Graph()}} only if the teb structure has been modified to speed up hot-\/starting from previous solutions. 
...
\end{DoxyWarning}
\begin{DoxyRefDesc}{待办事项}
\item[\mbox{\hyperlink{todo__todo000008}{待办事项}}]Should we also add neighbors to decrease jiggling/oscillations \end{DoxyRefDesc}
\begin{DoxySeeAlso}{参见}
...
\begin{DoxyRefDesc}{待办事项}
\item[\mbox{\hyperlink{todo__todo000006}{待办事项}}]Remove the scaling term for the alternative time cost. 
...
\item[\mbox{\hyperlink{todo__todo000007}{待办事项}}]The acceleration profile is not added at the moment. \end{DoxyRefDesc}
...
The current implementation calls a non-\/constrained sparse Levenberg-\/\+Marquardt algorithm. Constraints are considered by utilizing penalty approximations. Refer to the literature cited in the \mbox{\hyperlink{classteb__local__planner_1_1TebOptimalPlanner}{Teb\+Optimal\+Planner}} class description. \begin{DoxySeeAlso}{参见}
\mbox{\hyperlink{classteb__local__planner_1_1TebOptimalPlanner_a2b9ad598cec60b56906806603fa45497}{build\+Graph}} 
...
optimize\+TEB implements the main optimization loop. ~\newline
...
\item 
teb\+\_\+local\+\_\+planner/include/teb\+\_\+local\+\_\+planner/optimal\+\_\+planner.\+h\end{DoxyCompactItemize}
