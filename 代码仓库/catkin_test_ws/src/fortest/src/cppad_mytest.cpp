...
public:
    ...
    void operator()(ADvector& fg, const ADvector& x)
    {
        ...
        fg[0] = -sqrt(x1) - sqrt(x2) - sqrt(x3) - sqrt(x4) ;
        // constraints
        fg[1] = 1.1*x1+x2;
        fg[2] = 1.21*x1+1.1*x2+x3;
        fg[3] = 1.331*x1+1.21*x2+1.1*x3+x4;
        return;
    }
...
bool get_started(void)
{
    ...
    size_t ng = 3; // number of constraints
    ...
    Dvector gl(ng), gu(ng);
    gl[0] = -1.0e20;    gu[0] = 440;
    gl[1] = -1.0e20;    gu[1] = 484;
    gl[2] = -1.0e20; gu[2] = 532.4;
