...
\item[\mbox{\hyperlink{todo__todo000012}{待办事项}}]Move decision if the start or goal state should be marked as fixed or unfixed for the optimization to the \mbox{\hyperlink{classteb__local__planner_1_1TebOptimalPlanner}{Teb\+Optimal\+Planner}} class. \end{DoxyRefDesc}
...
\begin{DoxyRefDesc}{待办事项}
\item[\mbox{\hyperlink{todo__todo000015}{待办事项}}]implement a more efficient version that first performs a coarse search. 
...
\begin{DoxyRefDesc}{待办事项}
\item[\mbox{\hyperlink{todo__todo000014}{待办事项}}]implement a more efficient version that first performs a coarse search. 
...
\begin{DoxyRefDesc}{待办事项}
\item[\mbox{\hyperlink{todo__todo000016}{待办事项}}]implement a more efficient version that first performs a coarse search. 
...
Afterwards the start and goal pose are replaced by the new ones. The resulting discontinuity will not be smoothed. The optimizer has to smooth the trajectory in \mbox{\hyperlink{classteb__local__planner_1_1TebOptimalPlanner}{Teb\+Optimal\+Planner}}. ~\newline
 \begin{DoxyRefDesc}{待办事项}
\item[\mbox{\hyperlink{todo__todo000013}{待办事项}}]Smooth the trajectory here and test the performance improvement of the optimization. 
...
\item 
teb\+\_\+local\+\_\+planner/include/teb\+\_\+local\+\_\+planner/timed\+\_\+elastic\+\_\+band.\+h\end{DoxyCompactItemize}
